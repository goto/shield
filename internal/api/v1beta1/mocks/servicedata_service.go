...
func (_e *ServiceDataService_Expecter) GetKeyByURN(ctx interface{}, urn interface{}) *ServiceDataService_GetKeyByURN_Call {
	return &ServiceDataService_GetKeyByURN_Call{Call: _e.mock.On("GetKeyByURN", ctx, urn)}
}

func (_c *ServiceDataService_GetKeyByURN_Call) Run(run func(ctx context.Context, urn string)) *ServiceDataService_GetKeyByURN_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ServiceDataService_GetKeyByURN_Call) Return(_a0 servicedata.Key, _a1 error) *ServiceDataService_GetKeyByURN_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ServiceDataService_GetKeyByURN_Call) RunAndReturn(run func(context.Context, string) (servicedata.Key, error)) *ServiceDataService_GetKeyByURN_Call {
	_c.Call.Return(run)
	return _c
}
