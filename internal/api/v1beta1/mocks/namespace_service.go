...
// Create provides a mock function with given fields: ctx, ns, opts
func (_m *NamespaceService) Create(ctx context.Context, ns namespace.Namespace, opts ...namespace.ServiceOption) (namespace.Namespace, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, ns)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, namespace.Namespace, ...namespace.ServiceOption) (namespace.Namespace, error)); ok {
		return rf(ctx, ns, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, namespace.Namespace, ...namespace.ServiceOption) namespace.Namespace); ok {
		r0 = rf(ctx, ns, opts...)
	} else {
		r0 = ret.Get(0).(namespace.Namespace)
	}

	if rf, ok := ret.Get(1).(func(context.Context, namespace.Namespace, ...namespace.ServiceOption) error); ok {
		r1 = rf(ctx, ns, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - opts ...namespace.ServiceOption
func (_e *NamespaceService_Expecter) Create(ctx interface{}, ns interface{}, opts ...interface{}) *NamespaceService_Create_Call {
	return &NamespaceService_Create_Call{Call: _e.mock.On("Create",
		append([]interface{}{ctx, ns}, opts...)...)}
}

func (_c *NamespaceService_Create_Call) Run(run func(ctx context.Context, ns namespace.Namespace, opts ...namespace.ServiceOption)) *NamespaceService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]namespace.ServiceOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
				variadicArgs[i] = a.(namespace.ServiceOption)
			}
		}
		run(args[0].(context.Context), args[1].(namespace.Namespace), variadicArgs...)
	})
	return _c
}
...
func (_c *NamespaceService_Create_Call) RunAndReturn(run func(context.Context, namespace.Namespace, ...namespace.ServiceOption) (namespace.Namespace, error)) *NamespaceService_Create_Call {
	_c.Call.Return(run)
	return _c
}
