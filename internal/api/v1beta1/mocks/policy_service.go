...
// Create provides a mock function with given fields: ctx, pol, opts
func (_m *PolicyService) Create(ctx context.Context, pol policy.Policy, opts ...policy.ServiceOption) ([]policy.Policy, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, pol)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, policy.Policy, ...policy.ServiceOption) ([]policy.Policy, error)); ok {
		return rf(ctx, pol, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, policy.Policy, ...policy.ServiceOption) []policy.Policy); ok {
		r0 = rf(ctx, pol, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, policy.Policy, ...policy.ServiceOption) error); ok {
		r1 = rf(ctx, pol, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - pol policy.Policy
//   - opts ...policy.ServiceOption
func (_e *PolicyService_Expecter) Create(ctx interface{}, pol interface{}, opts ...interface{}) *PolicyService_Create_Call {
	return &PolicyService_Create_Call{Call: _e.mock.On("Create",
		append([]interface{}{ctx, pol}, opts...)...)}
}

func (_c *PolicyService_Create_Call) Run(run func(ctx context.Context, pol policy.Policy, opts ...policy.ServiceOption)) *PolicyService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]policy.ServiceOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
				variadicArgs[i] = a.(policy.ServiceOption)
			}
		}
		run(args[0].(context.Context), args[1].(policy.Policy), variadicArgs...)
	})
	return _c
}
...
func (_c *PolicyService_Create_Call) RunAndReturn(run func(context.Context, policy.Policy, ...policy.ServiceOption) ([]policy.Policy, error)) *PolicyService_Create_Call {
	_c.Call.Return(run)
	return _c
}
