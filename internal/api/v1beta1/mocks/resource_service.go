...
import (
	...
	schema "github.com/goto/shield/internal/schema"
)
...
// ResourceService_ListAllUserResources_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListAllUserResources'
type ResourceService_ListAllUserResources_Call struct {
	*mock.Call
}
...
func (_c *ResourceService_ListAllUserResources_Call) Return(_a0 map[string]map[string][]string, _a1 error) *ResourceService_ListAllUserResources_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// ResourceService_ListUserResourcesByType_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListUserResourcesByType'
type ResourceService_ListUserResourcesByType_Call struct {
	*mock.Call
}

// ListUserResourcesByType is a helper method to define mock.On call
//   - ctx context.Context
//   - userID string
//   - resourceType string
//   - permissions []string
...
func (_c *ResourceService_ListUserResourcesByType_Call) Return(_a0 map[string][]string, _a1 error) *ResourceService_ListUserResourcesByType_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *ResourceService) UpsertConfig(ctx context.Context, name string, config string) (schema.Config, error) {
	...
	var r0 schema.Config
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (schema.Config, error)); ok {
		return rf(ctx, name, config)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) schema.Config); ok {
		r0 = rf(ctx, name, config)
	} else {
		r0 = ret.Get(0).(schema.Config)
	}
...
func (_c *ResourceService_UpsertConfig_Call) Return(_a0 schema.Config, _a1 error) *ResourceService_UpsertConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ResourceService_UpsertConfig_Call) RunAndReturn(run func(context.Context, string, string) (schema.Config, error)) *ResourceService_UpsertConfig_Call {
	_c.Call.Return(run)
	return _c
}
