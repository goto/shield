...
type mockConstructorTestingTNewRelationTransformer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRelationTransformer(t mockConstructorTestingTNewRelationTransformer) *RelationTransformer {
