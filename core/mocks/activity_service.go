...
func (_m *ActivityService) Log(ctx context.Context, action string, actor string, data interface{}) error {
...
func (_c *ActivityService_Log_Call) Run(run func(ctx context.Context, action string, actor string, data interface{})) *ActivityService_Log_Call {
...
func (_c *ActivityService_Log_Call) RunAndReturn(run func(context.Context, string, string, interface{}) error) *ActivityService_Log_Call {
	_c.Call.Return(run)
	return _c
}
